# Infinite Maze Game
Demo: https://ezkidtrix.github.io/Infinite-Maze-Game/
...
### (You) The Player:
WASD/Arrow keys to move around the map, as you move in a direction, the player speed will increase until a certain point.
...
As you move around, the maze is constantly expanding outward, so you don't have to worry about ever hitting the end of it.